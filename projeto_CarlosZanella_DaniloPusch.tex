...
\author{Carlos Alberto Zanella \\ \vspace{0.3cm}Danilo Mendes Pusch}  	% Author name goes here


\postauthor{\footnotesize \usefont{OT1}{phv}{m}{sl} \color{Black} 
					\\
					 \vspace{0.3cm}Universidade Tecnológica Federal do Paraná - Câmpus Cornélio Procópio 								% Institution of author
...
% NÃO É PADRÃO TERMOS IMAGENS DENTRO DAS TABELAS.
% RECOMENDO UMA SEÇÃO DE IMAGENS NO FIM DO DOCUMENTO
% DEMONSTRANDO CADA PEÇA EM CÓDIGO DE REFERẼNCIA.
% A TABELA ANTERIOR ESTÁ AINDA COMENTADA E DISPONÍVEL
% CASO SEJA O ENTENDIMENTO DO GRUPO UTILIZÁ-LA.
...
\begin{figure}
	%	\centering
	\noindent\makebox[\textwidth][c]{
		\includegraphics[width=\textwidth]{mapa_mental}
	}
	\caption{Resumo gráfico}
	\label{mapa_mental}
\end{figure}
