...
\begin{itemize}
	\item Auxiliares administrativos
	\item Faturistas
	\item Secretária
	\item Estoquistas
	\item Encarregado do armazém
\end{itemize}
...
\begin{itemize}
	\item ERP (Uniface)
	\item Sistema de gestão de ativos (IBM Maximo)
	\item Sistema dos coletores
	\item Arterisk telefonia IP
	\item ????
\end{itemize}


\section{Estrutura predial existente}
Estrutura predial existente conforme figura 1.\ref{figura1} 
\begin{figure}
	\centering
...
Planta baixa e situação atual do prédio conforme figura 2.\ref{figura2} 
\begin{figure}
	\centering
...
Planta lógica conforme figura 3.\ref{figura3}  
\begin{figure}
	\centering
...
Relação do encaminhamento e seus respectivos custos conforme figura 4.\ref{figura4}  
\begin{figure}
	\centering
